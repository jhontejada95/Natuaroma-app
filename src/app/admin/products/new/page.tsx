    ...
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-foreground/60 mt-1 text-sm">Completa la información para publicar en la tienda.</p>
        </div>
      </div>
      ...
      <form action={createProduct} className="space-y-6">
        ...
        <div className="bg-surface rounded-xl border border-outline-variant p-6 space-y-6">
          <h2 className="font-display font-semibold text-primary border-b border-outline-variant pb-3">Información básica</h2>
        ...
        {/* Organización */}
        <div className="bg-surface rounded-xl border border-outline-variant p-6 space-y-6">
          <h2 className="font-display font-semibold text-primary border-b border-outline-variant pb-3">Organización</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
        ...
        <div className="bg-surface rounded-xl border border-outline-variant p-6 space-y-4">
          ...
          <CloudinaryUpload name="image_url" />
        </div>
